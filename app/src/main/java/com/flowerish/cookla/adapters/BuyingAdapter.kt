...
class BuyingAdapter : ListAdapter<BuyingIngredient, BuyingAdapter.BuyingViewHolder>(BuyingDiffUtil()) {
    ...
    class BuyingViewHolder(private val binding: RecyclerItemBuyingBinding): RecyclerView.ViewHolder(binding.root){
    ...
    class BuyingDiffUtil(): DiffUtil.ItemCallback<BuyingIngredient>() {
        override fun areItemsTheSame(oldItem: BuyingIngredient, newItem: BuyingIngredient): Boolean {
            return oldItem === newItem
        }

        override fun areContentsTheSame(oldItem: BuyingIngredient, newItem: BuyingIngredient): Boolean {
